 ...
 * @author kpadhikari
 */
public class FitControl_TestMyTemplate_KrishnaUI extends JFrame {
    ...
    public FitControl_TestMyTemplate_KrishnaUI() {
        initLookAndFeel();
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            new FitControl_TestMyTemplate_KrishnaUI().setVisible(true);
        });
    }
}
