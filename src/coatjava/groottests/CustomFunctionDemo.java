...
// https://github.com/KPAdhikari/groot/tree/master/src/main/java/org/jlab/groot/demo
...
public class CustomFunctionDemo {
	...
	public static void main(String[] args) {
		...
		H1F histogram = new H1F("histogram",100,-5.0,60.0); 
		//CustomFunction f1 = new CustomFunction("CustomFunction", -5.1, 5.1);
		T0FitFunction f1 = new T0FitFunction("T0FitFunction", -5.1, 50.1);
