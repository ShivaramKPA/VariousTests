/*
 *  Code from https://www.geeksforgeeks.org/image-processing-java-set-2-get-set-pixels/
 */
...
public class GetSetPixels
{
    public static void main(String args[])throws IOException
    {
        ...
        try
        {
            ...
            f = new File("src/imageProcessing/blackandwhite.jpg");
            img = ImageIO.read(f);
        }
        catch(IOException e)
        {
        ...
        */
        ...
        try
        {
            f = new File("src/imageProcessing/Out.jpg");
