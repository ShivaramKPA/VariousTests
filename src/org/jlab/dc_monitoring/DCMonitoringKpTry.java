...
public class DCMonitoringKpTry implements IDataEventListener {
	...
	public DCMonitoringKpTry() {
		...
		mainPanel.add(tabbedPane);
                ...
                //kp: following adds the pane with those control buttons for selecting
                //   various files (hipo, evio etc) and actions such as start, reset 
                //   etc (marked by '<', '>' '||' '|>', 'E', 'Et', 'H', etc ...
...
//		enTB.init();
	...
	public static void main(String[] args) {
		...
		DCMonitoringKpTry viewer = new DCMonitoringKpTry();
