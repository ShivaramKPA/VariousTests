...
//                              = 3;   // for using B-field also from h3BTXmap  
    ...
    //A temporary variable. Should be replaced with radio buttons or comboBox to choose between different options
    protected static final int kppOrCosmic = 2; //1 for KPP, 2 for cosmic
    protected static final boolean debug = true;
    protected static final boolean[] angularBinsSelectedByDefault = {
