...
*      to the Thread constructor, as in this example.
...
*      implementation of run, as in the definingStartingThreadSubclassingThread.java. 
*
...
public class definingStartingThreadImplementingRunnable implements Runnable {
    public void run() {
    ...
    public static void main(String args[]) {
        (new Thread(new definingStartingThreadImplementingRunnable())).start();
        System.out.println("Hello from '" + Thread.currentThread().getName()
                + "' thread with ID = " + Thread.currentThread().getId()); 
